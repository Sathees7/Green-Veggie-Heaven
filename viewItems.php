      ...
      <table class="product-display-table">
        ...
        ?>
         ...
         <td><?php echo "<img src='" . $row['image'] . "' height='100'>"; ?></td>
            ...
            <td>
               <a href="updateItem.php?id=<?php echo $row['itemID']; ?>" class="btn"> <i class="fas fa-edit"></i> edit </a>
               <a href="deleteItem.php?delete=<?php echo $row['itemID']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
