...
<div class="container">
   <div class="product-display">
      <table class="product-display-table">
        ...
        $result = mysqli_query($con, "select * from Promotion");
        while ($row = mysqli_fetch_assoc($result)){
        ?>
         <tr>
         <td><?php echo "<img src='" . $row['image'] . "' height='100'>"; ?></td>
            ...
            <td>
               <a href="updatePromotion.php?id=<?php echo $row['promotionID']; ?>" class="btn"> <i class="fas fa-edit"></i>Update</a>
               <a href="deletePromotion.php?delete=<?php echo $row['promotionID']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
