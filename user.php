...
<div class="container">
<h3 style="text-align: center; color: #192a56; 	font-size: 3rem;">User Details</h3>
      ...
      <table class="product-display-table">
        ...
        ?>
         ...
         <td><?php echo $row['name']; ?></td>
            ...
            <td>
               <a href="deleteUser.php?delete=<?php echo $row['customerID']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
